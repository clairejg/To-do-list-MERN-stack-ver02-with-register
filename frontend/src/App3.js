  ...
  // const textUserName;
    ...
    <div className="container">
        <div className="titleDiv">
          ...
          <h1> To-Do Application 2
          </h1>
               <p className="userNameDiv">Username2:<input className='userNameInput'
                type="text"
...
Event (e):
First you have 'e' which is short for event. To understand what it does change onChange={(e) => setName(e.target.value)} to onChange={(e) => console.log(e)}.
// Inspect the log and you'll find a list of events in which one of them is target. Open target (if not already opened) and within target, you'll find value. 
